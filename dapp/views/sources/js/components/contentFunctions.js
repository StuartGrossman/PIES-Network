var contentFunctions = (function(userObject, firebaseDataBase){
  ...
  function createEventListener(videoStatus, contentElementLink, lookup){
  ...
  function createResponseContentWindows(data, id, contentData){
    ...
    console.log('currentContent var', currentContent)
    ...
    //setting links
    console.log(modalBody.children[2].childNodes[1].childNodes[3].childNodes[1].childNodes[1].childNodes[1])
